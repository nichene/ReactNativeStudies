...
import {ADD_BLACK, DELETE, EX1, EX3, EX7, LIST, SHARE} from '../image';
        ...
        <ScrollView>
          ...
          <Card>
            <TouchableOpacity style={styles.add}>
              <Image height={8} width={8} source={SHARE} />
              <Text style={styles.addText}>Share with your friends ...</Text>
            </TouchableOpacity>
          </Card>
          <Card>
            <TouchableOpacity style={styles.add}>
              <Image height={8} width={8} source={DELETE} />
              <Text style={styles.addText}>Delete this Set ...</Text>
            </TouchableOpacity>
          </Card>
        </ScrollView>
      </SafeAreaView>
